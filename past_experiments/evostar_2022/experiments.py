...
for seed in range(20, 50):
    random.seed(seed)
    evaluate_adam_fashion(0.0012769019343367, 0.0735486046886975, 0.781617047896626)
    random.seed(seed)
    evaluate_adam_cifar(0.0016343646073093, 0.813444834775321, 0.7102255853502537)
    random.seed(seed)
    evaluate_rmsprop_fashion(0.0009665770490416, 0.8577853587488521)
    random.seed(seed)
    evaluate_ades_cifar(0.9222590782233158, 0.6928509515158905)
    random.seed(seed)
    evaluate_ades_fashion(0.8762100653275976, 0.7613194430532176)
