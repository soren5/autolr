...
for seed in range(20, 50):
    random.seed(seed)
    evaluate_rmsprop_cifar(0.0008515837876186, 0.6481252504424939)
    random.seed(seed)
    evaluate_nesterov_fashion(0.0999883114942919, 0.8671457204528904)
    random.seed(seed)
    evaluate_nesterov_cifar(0.0090731747682882, 0.9843349819133048)
    random.seed(seed)
    evaluate_sign_fashion(0.0009)
    random.seed(seed)
    evaluate_sign_cifar(0.0005021917927373)
