...
def find_params(phen_params):
    ...
    if 'IMAGENET_CONFIG' in params:
        json_path = params['IMAGENET_CONFIG']
        with open(json_path, 'r') as f:
            import json
            imagenet_params = json.load(f)
            validation_size = imagenet_params['VALIDATION_SIZE']
            fitness_size = imagenet_params['FITNESS_SIZE']
            batch_size = imagenet_params['BATCH_SIZE']
            epochs = imagenet_params['EPOCHS']
            patience = imagenet_params['PATIENCE']
    else:
