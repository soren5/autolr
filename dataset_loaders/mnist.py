...
class MNIST_Dataset:
    ...
    def load_data_for_evolution(self):
        # Load the MNIST dataset, split it into training, validation and fitness sets, and preprocess when applicable.
        # MNIST test set is not used in the evolution, it is only used in the final benchmark evaluation, so we can ignore it here.
    ...
    def load_data_for_benchmark(self):
        # Load the MNIST dataset, split it into training, validation sets.
